...
export const signup = async (req, res, next) => {
    const {name, email, phonenumber, phonenumber2, phonenumber3, phonenumber4,
    address,country,State,district, city, password, bloodgroup, dateofbirth, maritalstatus} = req.body;
    ...
    let existUser;
       ...
       return console.log(err);
        ...
        if (existUser) {
        return res.status(400).json({message: "Email is alreay used in exist account! Login instead."});
        }
